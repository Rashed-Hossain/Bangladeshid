...
# Author : HTR-TECH | RASHED HOSSAIN
# https://Wwwwwwwwwwww.Mizan.Vau8080
# https://Wwwwwwwwwwww.Mizan.Vau8080
# ------------------------------------------
# Embedded File   : Rashed
...
\033[1;94mFacebook id link : \033[1;93mhttps://www.facebook.com/Wwwwwwwwwwww.Mizan.Vau8080
...
def pilih_login():
    peak = raw_input("\n\033[1;95mRASHEDCHOOSE: \033[1;95m")
    if peak =="":
...
def action():
    peak = raw_input('\n\033[1;95mRASHEDCHOOSE:\033[1;97m')
    if peak =='':
        ...
        try:
            c = raw_input("\033[1;96mRASHEDCHOOSE : ")
            k="03"
            idlist = ('.txt')
